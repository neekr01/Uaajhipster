...
export type IQuoteState = IPaginationBaseState;
      ...
      <div>
        ...
        <div className="table-responsive">
          {quoteList && quoteList.length > 0 ? (
            <Table responsive aria-describedby="quote-heading">
              <thead>
                <tr>
                  <th className="hand" onClick={this.sort('id')}>
                    ID <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('symbol')}>
                    Symbol <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('price')}>
                    Price <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('lastTrade')}>
                    Last Trade <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {quoteList.map((quote, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{quote.price}</td>
                    <td>
                      <TextFormat type="date" value={quote.lastTrade} format={APP_DATE_FORMAT} />
                    </td>
            ...
            <div className="alert alert-warning">No Quotes found</div>
          )}
        </div>

...
To build the final jar and optimize the uiuaafinal application for production, run:
...
Then navigate to [http://localhost:2003](http://localhost:2003) in your browser.
